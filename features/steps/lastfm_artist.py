...
from pages.lastfm_results_page import ResultsPageLastFm
...
def step_search_artist(context, artist_name):
    ...
    context.lastfm_results = ResultsPageLastFm(context.driver)
...
@then('la fecha del último release debe ser "{expected_date}"')
